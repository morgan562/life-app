      ...
      <div className="w-full max-w-md rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm">
        ...
        <div className="mt-6">
          {email ? (
            <button
              onClick={signOut}
              className="w-full rounded-xl border border-neutral-300 px-4 py-2 text-sm text-black hover:bg-neutral-50"
            >
              Sign out
            </button>
          ) : (
            <button
              ...
              className="w-full rounded-xl border border-neutral-800 bg-white px-4 py-2 text-sm text-black hover:bg-neutral-50"
            >
              Sign in with Google
            </button>
          )}
